...
public class UserControllerTest {
    ...
    @Test
    public void shouldPostUserWithoutName() throws Exception {
    ...
    @Test
    public void shouldNotPostUserWithEmptyEmail() throws Exception {
    ...
    public void shouldUpdateUser() throws Exception {
        UserDto user = new UserDto(1, "update", "update@user.com");
        String jsonUser = objectMapper.writeValueAsString(userDto);

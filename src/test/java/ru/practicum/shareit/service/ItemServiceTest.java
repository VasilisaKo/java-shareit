...
class ItemServiceTest {
    ...
    public void testItemResponseDto() {
        ...
        ItemResponseDto.Owner owner = new ItemResponseDto.Owner(2, "Test Owner");
    ...
    public void testToItemResponseDto() {
        ...
        booking1.setBooker(new User(3, "Ivan", "ivan@mail.ru"));
        ...
        booking2.setBooker(new User(3, "Petr", "petr@mail.ru"));

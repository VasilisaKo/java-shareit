...
public class BookingService {
    ...
    public List<BookingResponseDto> getAllReserve(Integer userId, State state, String typeUser, int from, int size) throws Throwable {
        ...
        switch (state) {
            ...
            case REJECTED:
                ...
                break;
            default:
                throw new Throwable("UNSUPPORTED_STATUS");
        }
